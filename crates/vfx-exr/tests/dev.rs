...
extern crate vfx_exr;
extern crate smallvec;

use vfx_exr::prelude::*;

use vfx_exr::image::validate_results::ValidateResult;
use vfx_exr::meta::header::Header;
...
fn exr_files() -> impl Iterator<Item = PathBuf> {
    walkdir::WalkDir::new("../../test/assets-exr/valid")
        .into_iter()
...
pub fn test_roundtrip() {
    // works
    //let path = "../../test/assets-exr/fuzzed/b44_overly_restrictive_assert.exr";
    let path = "../../test/assets-exr/valid/custom/compression_methods/f32/pxr24.exr";

    // worksn't
    // let path = "../../test/assets-exr/valid/openexr/Chromaticities/Rec709_YC.exr"; // subsampling
    // let path = "../../test/assets-exr/valid/openexr/LuminanceChroma/Flowers.exr"; // subsampling

    // let path = "../../test/assets-exr/valid/openexr/IlmfmlmflmTest/test_native1.exr";
    // let path = "../../test/assets-exr/valid/openexr/IlmfmlmflmTest/test_native2.exr"; // contains NaN

    // deep data?
    // let path = "../../test/assets-exr/valid/openexr/v2/Stereo/Balls.exr";
    // let path = "../../test/assets-exr/valid/openexr/v2/Stereo/Ground.exr";

    println!("{:?}", vfx_exr::meta::MetaData::read_from_file(path, true));
